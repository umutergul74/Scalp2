    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "        print(f'  Overall Accuracy: {accuracy_score(labels, y_pred):.4f}')\n",
                "        print(f'  ---')\n",
                "        for i, name in enumerate(cls_names):\n",
                "            print(f'  {name}: Prec={p_per[i]:.4f}  Rec={r_per[i]:.4f}  F1={f_per[i]:.4f}')\n",
                "        print(f'  ---')\n",
                "        print(f'  Macro Avg F1: {f1_score(labels, y_pred, average=\"macro\", zero_division=0):.4f}')\n",
                "        print(f'  Weighted Avg F1: {f1_score(labels, y_pred, average=\"weighted\", zero_division=0):.4f}\\n')\n",
                "        \n",
                ...
                "            mf.write(f'Macro Avg F1: {f1_score(labels, y_pred, average=\"macro\", zero_division=0):.4f}\\n')\n",
                "            mf.write(f'Weighted Avg F1: {f1_score(labels, y_pred, average=\"weighted\", zero_division=0):.4f}\\n')\n",
                "            \n",
                "    else:\n",
